...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  permissionRules: 'permission-presets.md',
  planMode: 'plan.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  DeferredActivationResult: 'deferred-tool activation outcome is owned by packages/core/tool-search/src/index.ts',
  DeferredToolRegistration: 'deferred-tool registration payload is owned by packages/core/tool-search/src/index.ts',
  DeferredSearchHit: 'deferred-tool search hit is owned by packages/core/tool-search/src/index.ts',
  ...
  MicrocompactResult: 'microcompaction outcome payload is owned by packages/compaction/compaction-micro/src/index.ts',
  PermissionMode: 'permission mode vocabulary is owned by packages/interaction/permission-rules/src/types.ts',
