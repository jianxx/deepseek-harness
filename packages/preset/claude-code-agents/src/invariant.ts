/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-claude-code-agents`.
 * @module @deepseek-ai/dsh-claude-code-agents/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-claude-code-agents'
