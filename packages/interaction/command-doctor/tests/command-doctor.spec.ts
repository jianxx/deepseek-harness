...
import * as commandDoctor from '@deepseek-ai/dsh-command-doctor'
import { formatDoctorReport, type DoctorReport } from '@deepseek-ai/dsh-command-doctor/doctor'
...
describe('@deepseek-ai/dsh-command-doctor registration', () => {
