/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-command-doctor`.
 * @module @deepseek-ai/dsh-command-doctor/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-command-doctor'
