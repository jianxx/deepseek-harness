...
import * as commandStatus from '@deepseek-ai/dsh-command-status'
import { formatStatus, lastModel } from '@deepseek-ai/dsh-command-status/status'
...
describe('@deepseek-ai/dsh-command-status registration', () => {
