...
import { interpolateEnvVars, runHttpHook } from '@deepseek-ai/dsh-hook-protocol/src/http.ts'
import type { HttpHook } from '@deepseek-ai/dsh-hook-protocol/src/types.ts'
