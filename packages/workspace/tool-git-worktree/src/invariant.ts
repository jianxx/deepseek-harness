/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-tool-git-worktree`.
 * @module @deepseek-ai/dsh-tool-git-worktree/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-tool-git-worktree'
