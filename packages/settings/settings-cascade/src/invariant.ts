/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-settings-cascade`.
 * @module @deepseek-ai/dsh-settings-cascade/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-settings-cascade'
