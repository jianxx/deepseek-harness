/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-mcp-config`.
 * @module @deepseek-ai/dsh-mcp-config/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-mcp-config'
