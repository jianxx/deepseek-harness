/**
 * MCP workspace-configuration loader (`@deepseek-ai/dsh-mcp-config`).
 *
 ...
 * and translates the accepted servers into `@deepseek-ai/dsh-mcp-client`
 ...
 *
 * @module @deepseek-ai/dsh-mcp-config
 */
