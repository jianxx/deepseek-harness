...
import { promptSkillName, syncPrompts } from '@deepseek-ai/dsh-mcp-client/src/prompts.ts'
import { isSkillName } from '@deepseek-ai/dsh-skill'
import { syncResources, resourcePublicName } from '@deepseek-ai/dsh-mcp-client/src/resources.ts'
