/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-command-export`.
 * @module @deepseek-ai/dsh-command-export/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-command-export'
