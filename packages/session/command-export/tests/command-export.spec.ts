...
import * as commandExport from '@deepseek-ai/dsh-command-export'
import {
  contentText,
  renderJson,
  renderMarkdown,
  renderTranscript,
} from '@deepseek-ai/dsh-command-export/transcript'
import { parseExport, resolveOutput } from '@deepseek-ai/dsh-command-export'
...
describe('@deepseek-ai/dsh-command-export registration', () => {
