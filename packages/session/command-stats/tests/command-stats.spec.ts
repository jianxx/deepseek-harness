...
import * as commandStats from '@deepseek-ai/dsh-command-stats'
import { foldStats, formatStatsReport } from '@deepseek-ai/dsh-command-stats/stats'
...
describe('@deepseek-ai/dsh-command-stats registration', () => {
