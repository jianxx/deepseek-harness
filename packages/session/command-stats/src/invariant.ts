/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-command-stats`.
 * @module @deepseek-ai/dsh-command-stats/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-command-stats'
