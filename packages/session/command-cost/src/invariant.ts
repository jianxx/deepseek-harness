/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-command-cost`.
 * @module @deepseek-ai/dsh-command-cost/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-command-cost'
