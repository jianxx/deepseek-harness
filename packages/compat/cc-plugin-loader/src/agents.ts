...
import { loadAgentsDir } from '@deepseek-ai/dsh-claude-code-agents'
import type { AgentDefinition } from '@deepseek-ai/dsh-claude-code-agents'
...
/** A thin forwarder provider: overlays an AgentDefinition and delegates. */
class AgentProvider implements SubagentBackend {
