/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-cc-output-styles`.
 * @module @deepseek-ai/dsh-cc-output-styles/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-cc-output-styles'
